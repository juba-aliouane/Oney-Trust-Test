...
// Returns the private 'App\Repository\FullAddressRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FullAddressRepository.php';

return $this->privates['App\\Repository\\FullAddressRepository'] = new \App\Repository\FullAddressRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
