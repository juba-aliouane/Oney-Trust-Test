...
// Returns the private 'App\Repository\FieldsAddressRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FieldsAddressRepository.php';

return $this->privates['App\\Repository\\FieldsAddressRepository'] = new \App\Repository\FieldsAddressRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
